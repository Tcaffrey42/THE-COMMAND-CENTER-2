...
/* V2.15.5 COMMAND AI branding + portfolio question layer */
.commandHero{background:radial-gradient(circle at 12% 12%,rgba(255,255,255,.18),transparent 28%),linear-gradient(135deg,#030712,#111827 52%,#09090b);color:#fff;border-radius:30px;padding:24px;box-shadow:0 24px 70px rgba(0,0,0,.18);margin-bottom:16px;overflow:hidden;position:relative}
.commandHero h1{font-size:36px;margin:8px 0;letter-spacing:-.04em}.commandHero p{color:#d4d4d8;max-width:850px;line-height:1.45;margin:0}.commandInputRow{display:grid;grid-template-columns:1fr auto;gap:10px;align-items:center}.promptChip{border:1px solid var(--line);border-radius:16px;background:#fafafa;padding:12px 13px;font-weight:950;cursor:pointer;margin-bottom:8px}.promptChip:hover{background:#09090b;color:#fff;transform:translateY(-1px)}.commandAnswer h2{margin:6px 0 8px}.commandResultList{display:grid;gap:9px;margin-top:12px}.commandResult{display:grid;grid-template-columns:1fr auto;gap:12px;align-items:center;border:1px solid var(--line);background:#fff;border-radius:18px;padding:12px;cursor:pointer}.commandResult:hover{box-shadow:0 12px 28px rgba(0,0,0,.08);transform:translateY(-1px)}.commandNextSteps{border:1px solid var(--line);border-radius:18px;background:#fafafa;padding:13px;margin-top:12px}.chat .bubble.ai .commandAnswer .muted{color:#52525b}@media(max-width:900px){.commandInputRow,.commandResult{grid-template-columns:1fr}.commandHero h1{font-size:29px}}
